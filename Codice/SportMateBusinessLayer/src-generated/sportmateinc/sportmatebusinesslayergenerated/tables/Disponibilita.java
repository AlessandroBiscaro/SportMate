...
import sportmateinc.sportmatebusinesslayergenerated.tables.records.DisponibilitaRecord;
...
public class Disponibilita extends TableImpl<DisponibilitaRecord> {
    ...
    /**
     * The column <code>Disponibilita.prenotato</code>.
     */
    public final TableField<DisponibilitaRecord, Integer> PRENOTATO = createField(DSL.name("prenotato"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super Integer, ? super String, ? super BigDecimal, ? super Integer, ? super Integer, ? super Integer, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super Integer, ? super String, ? super BigDecimal, ? super Integer, ? super Integer, ? super Integer, ? extends U> from) {
